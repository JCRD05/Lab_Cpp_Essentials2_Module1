...
bool Fraction::lessThan(Fraction fraction)
{
	reduce(); fraction.reduce();
	if (toDouble() < fraction.toDouble()) { return true; }
	else { return false; }
}

bool Fraction::equalTo(Fraction fraction)
{
	reduce(); fraction.reduce();
	if (toDouble() == fraction.toDouble()) { return true; }
	else { return false; }
...
bool Fraction::greaterThan(Fraction fraction)
{
	reduce(); fraction.reduce();
	if (toDouble() > fraction.toDouble()) { return true; }
	else { return false; }
